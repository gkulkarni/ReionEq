...
set_plot, 'ps'
device, filename='abr_halo_z6_talk.ps', xsize=7.0, ysize=7.0, $
...
; Plot everything
  ...
  ;; plot, ms3_cbyfe, cs3_cbyfe, /xlog, xrange=[1.0e8, 1.0e11], $
  ;;       yrange=[-0.2,1.0], xtitle='halo mass', ytitle='[C/Fe]', $
  ;;       symsize=0.5, thick=3, xthick=3, ythick=3 
  ;; oplot, ms1_cbyfe, cs1_cbyfe, color=2, symsize=0.5, thick=3
  ;; oplot, ms_cbyfe, cs_cbyfe, color=3, symsize=0.5, thick=3
  ;; legend, ['z=6'], /right, box=0

  ;; plot, ms3_obysi, cs3_obysi, /xlog, xrange=[1.0e8, 1.0e11], $
  ;;       yrange=[-0.5,1.0], xtitle='halo mass', ytitle='[O/Si]', $
  ;;       symsize=0.5, thick=3, xthick=3, ythick=3 
  ;; oplot, ms1_obysi, cs1_obysi, color=2, symsize=0.5, thick=3
  ;; oplot, ms_obysi, cs_obysi, color=3, symsize=0.5, thick=3
  ;; legend, ['z=6'], /right, box=0

  ;; plot, ms3_znbyfe, cs3_znbyfe, /xlog, xrange=[1.0e8, 1.0e11], $
  ;;       yrange=[-1.0,0.0], xtitle='halo mass', ytitle='[Zn/Fe]', $
  ;;       symsize=0.5, thick=3, xthick=3, ythick=3
  ;; oplot, ms1_znbyfe, cs1_znbyfe, color=2, symsize=0.5, thick=3
  ;; oplot, ms_znbyfe, cs_znbyfe, color=3, symsize=0.5, thick=3
  ;; legend, ['z=6'], /bottom, box=0, /right

  ;; plot, ms3_nbyo, cs3_nbyo, /xlog, xrange=[1.0e8, 1.0e11], $
  ;;       yrange=[-3.0,-2.6], xtitle='halo mass', ytitle='[N/O]', $
  ;;       symsize=0.5, thick=3, xthick=3, ythick=3 
  ;; oplot, ms1_nbyo, cs1_nbyo, color=2, symsize=0.5, thick=3
  ;; oplot, ms_nbyo, cs_nbyo, color=3, symsize=0.5, thick=3
  ;; legend, ['z=6'], /bottom, box=0, /right

  ;; plot, cs3_cbyfe2, ns3_cbyfe, xtitle='[C/Fe]', ytitle='d!E2!NN/dXd[C/Fe]', $
  ;;       xrange=[-0.2,1.0], symsize=0.5, thick=3, xthick=3, ythick=3
  ;; oplot, cs1_cbyfe2, ns1_cbyfe, color=2, symsize=0.5, thick=3 
  ;; oplot, cs_cbyfe2, ns_cbyfe, color=3, symsize=0.5, thick=3
  ;; legend, ['z=6'], box=0, /right

  plot, cs3_obysi2, ns3_obysi, xtitle='[O/Si]', ytitle='d!E2!NN/dXd[O/Si]', $
        xrange=[-0.5,1.0], symsize=0.5, thick=3, xthick=3, ythick=3
  oplot, cs1_obysi2, ns1_obysi, color=2, symsize=0.5, thick=3
  oplot, cs_obysi2, ns_obysi, color=3, symsize=0.5, thick=3

  ;; plot, cs3_znbyfe2, ns3_znbyfe, xtitle='[Zn/Fe]', ytitle='d!E2!NN/dXd[Zn/Fe]', $
  ;;       xrange=[-1.0,0.0], symsize=0.5, thick=3, xthick=3, ythick=3
  ;; oplot, cs1_znbyfe2, ns1_znbyfe, color=2, symsize=0.5, thick=3
  ;; oplot, cs_znbyfe2, ns_znbyfe, color=3, symsize=0.5, thick=3
  ;; legend, ['z=6'], box=0

  ;; plot, cs3_nbyo2, ns3_nbyo, xtitle='[N/O]', ytitle='d!E2!NN/dXd[N/O]', $
  ;;       xrange=[-3.0,-2.6], symsize=0.5, thick=3, xthick=3, ythick=3
...
;---------------
  ...
  oplot, cs3_obysi2, ns3_obysi, color=1, linestyle=2, thick=3
  oplot, cs1_obysi2, ns1_obysi, color=2, linestyle=2, thick=3
  oplot, cs_obysi2, ns_obysi, color=3, linestyle=2, thick=3

legend, ['z = 6', 'z = 2'], linestyle=[0,2], color=[1,1], box=0, /right 
