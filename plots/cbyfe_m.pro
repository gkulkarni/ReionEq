  c_data2 = read_ascii('set158/halos_c.out', template=stars_template)
  fe_data2 = read_ascii('set158/halos_fe.out', template=stars_template)
  ...
  for i = 0, array_length-1 do begin 
     ...
     ; Find mass of a halo at z=3 that has the same circular velocity as this halo. 
...
;--------------------------------------
  ...
  c_data2 = read_ascii('set163/halos_c.out', template=stars_template)
  fe_data2 = read_ascii('set163/halos_fe.out', template=stars_template)
  m_data2 = read_ascii('set163/halos.out', template=stars_template) 
  n_data2 = read_ascii('set34/nofmh.out', template=stars_template) 
  gas_data2 = read_ascii('set163/halos_gas.out', template=stars_template)
...
;-----------------
  ...
  ns3 = dndx3 ; rebin(dndx3, array_length/2) 
