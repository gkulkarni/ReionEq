...
set_plot, 'ps'
device, filename='gpi_talk.ps', xsize=7.0, ysize=7.0, /inches, color=1, yoffset=1.0
...
gpi = gpi * 1.0e12 
cgplot, redshift, gpi, /ylog, xrange=[2,100], yrange=[1.0e-14, 1.0e1], xstyle=1, xtitle='z', $
        ytitle='log!D10!N($\Gamma$!DHI!N / 10!E-12!Ns!E-1!D)', ytickformat='exp2', /xlog, $
        position=[0.1,0.1,0.9,0.7], /nodata 
gpi1 = gpi 
redshift1 = redshift 
...
legend, ['Faucher-Giguere 08', 'Meiksin and White 04', 'Bolton and Haehnelt 07'], $
        linestyle=[0,0,0], psym=[8,8,8], color=[4,3,2], /right, box=0, charsize=1.0

;---------------
vline, 8.5, linestyle=2
tick = replicate(' ',3)
plot, redshift, ratio, position=[0.1,0.7,0.9,0.97], /xlog, /ylog, xrange=[2,100], $
      xstyle=1, xtickname=tick, ytitle='ratio', thick=5
vline, 8.5, linestyle=2
device, /close_file
set_plot, 'X'
