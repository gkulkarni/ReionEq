...
halos_data = read_ascii('set7/avghalos.out', template=stars_template)
...
;; zn_data = read_ascii('set7/avghalos_Zn.out', template=stars_template)
;; fe_data =  read_ascii('set7/avghalos_fe.out', template=stars_template)
...
;; solar = -1.87 ; O/H 
;; o_data = read_ascii('set22/avghalos_o.out', template=stars_template)
;; gas_data =  read_ascii('set22/avghalos_gas.out', template=stars_template)
...
;; solar = -2.78 ; O/H 
;; o_data = read_ascii('set22/avghalos_fe.out', template=stars_template)
;; gas_data =  read_ascii('set22/avghalos_gas.out', template=stars_template)
...
solar = 1.17
o_data = read_ascii('set7/avghalos_o.out', template=stars_template)
si_data =  read_ascii('set7/avghalos_Si.out', template=stars_template)
