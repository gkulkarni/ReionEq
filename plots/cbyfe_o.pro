  c_data2 = read_ascii('set129/halos_c.out', template=stars_template)
  fe_data2 = read_ascii('set129/halos_fe.out', template=stars_template)
  m_data2 = read_ascii('set129/halos.out', template=stars_template) 
  n_data2 = read_ascii('set34/nofmh.out', template=stars_template) 
  gas_data2 = read_ascii('set129/halos_gas.out', template=stars_template)
...
;--------------------------------------
  ...
  c_data2 = read_ascii('set164/halos_c.out', template=stars_template)
  fe_data2 = read_ascii('set164/halos_fe.out', template=stars_template)
