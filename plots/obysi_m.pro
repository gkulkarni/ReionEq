...
; Fe = Si 
  ...
  c_data2 = read_ascii('set158/halos_o.out', template=stars_template)
  fe_data2 = read_ascii('set158/halos_Si.out', template=stars_template)
  m_data2 = read_ascii('set158/halos.out', template=stars_template) 
  n_data2 = read_ascii('set34/nofmh.out', template=stars_template) 
  gas_data2 = read_ascii('set158/halos_gas.out', template=stars_template)

  c2 = c_data2.field001[lcolumn_obysim:*,row]
  fe2 = fe_data2.field001[lcolumn_obysim:*,row]
  m2 = m_data2.field001[lcolumn_obysim:*,row]
  n2 = n_data2.field001[lcolumn_obysim:*,row]
  gas2 = gas_data2.field001[lcolumn_obysim:*,row]
...
;--------------------------------------
  ...
  c_data2 = read_ascii('set165/halos_o.out', template=stars_template)
  fe_data2 = read_ascii('set165/halos_Si.out', template=stars_template)
  m_data2 = read_ascii('set165/halos.out', template=stars_template) 
  n_data2 = read_ascii('set34/nofmh.out', template=stars_template) 
  gas_data2 = read_ascii('set165/halos_gas.out', template=stars_template)
