...
set_plot, 'ps'
device, filename='abr_171.ps', xsize=12.0, ysize=9.6, /inches, color=1, yoffset=1.0
...
;----------------------------------------
  ...
  c_data2 = read_ascii('set171/halos_c.out', template=stars_template)
  fe_data2 = read_ascii('set171/halos_fe.out', template=stars_template)
  m_data2 = read_ascii('set171/halos.out', template=stars_template) 
  n_data2 = read_ascii('set34/nofmh.out', template=stars_template) 
  gas_data2 = read_ascii('set171/halos_gas.out', template=stars_template)
...
; Fe = Si 
  ...
  c_data2 = read_ascii('set171/halos_o.out', template=stars_template)
  fe_data2 = read_ascii('set171/halos_Si.out', template=stars_template)
  m_data2 = read_ascii('set171/halos.out', template=stars_template) 
  n_data2 = read_ascii('set34/nofmh.out', template=stars_template) 
  gas_data2 = read_ascii('set171/halos_gas.out', template=stars_template)
...
; Fe = Fe
  ...
  c_data2 = read_ascii('set171/halos_Zn.out', template=stars_template)
  fe_data2 = read_ascii('set171/halos_fe.out', template=stars_template)
  m_data2 = read_ascii('set171/halos.out', template=stars_template) 
  n_data2 = read_ascii('set34/nofmh.out', template=stars_template) 
  gas_data2 = read_ascii('set171/halos_gas.out', template=stars_template)
...
; Fe = O
  ...
  c_data2 = read_ascii('set171/halos_N.out', template=stars_template)
  fe_data2 = read_ascii('set171/halos_o.out', template=stars_template)
  m_data2 = read_ascii('set171/halos.out', template=stars_template) 
  n_data2 = read_ascii('set34/nofmh.out', template=stars_template) 
  gas_data2 = read_ascii('set171/halos_gas.out', template=stars_template)
