  c_data2 = read_ascii('set125/halos_c.out', template=stars_template)
  fe_data2 = read_ascii('set125/halos_fe.out', template=stars_template)
...
;--------------------------------------
  ...
  c_data2 = read_ascii('set126/halos_c.out', template=stars_template)
  fe_data2 = read_ascii('set126/halos_fe.out', template=stars_template)
