...
lcolumn_obysio = 100
  ...
  c_data2 = read_ascii('set159/halos_o.out', template=stars_template)
  fe_data2 = read_ascii('set159/halos_Si.out', template=stars_template)
  m_data2 = read_ascii('set159/halos.out', template=stars_template) 
  n_data2 = read_ascii('set34/nofmh.out', template=stars_template) 
  gas_data2 = read_ascii('set159/halos_gas.out', template=stars_template)

  c2 = c_data2.field001[lcolumn_obysio:*,row]
  fe2 = fe_data2.field001[lcolumn_obysio:*,row]
  m2 = m_data2.field001[lcolumn_obysio:*,row]
  n2 = n_data2.field001[lcolumn_obysio:*,row]
  gas2 = gas_data2.field001[lcolumn_obysio:*,row]
