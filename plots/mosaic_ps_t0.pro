...
plot, z, Zmetal, /xlog, xrange=[1,50], ytitle='log!D10!N(Z/Z!D!9n!X!N)', $
      xstyle=1, yrange=[-6.0,0.5], /nodata, position=[x1,0.1,x1+plotwidth,0.7], $
      xtitle='redshift', ytickformat='metlabel', xtickname=tick, ystyle=1
axlabel, [1.0, 10.0, 50.0], /xaxis, charsize=1.5, format='(I)'
oplot, z, Zmetal, color=5 

vline, 8.5, linestyle=2
xyouts, 7.5, -1.0, 'z!Dreion!N', orientation=90.0, charsize=1.5, alignment=0.5

; legend, ['Pop. III IMF: 100-260 M!D!9n!X', 't!Denrich!N=10!E9!N Myr'], charsize=1.1, box=0
; al_legend, ['Pop. III IMF: 100-260 M!D!9n!X', 't!Ddelay!N=0 yr'],
; charsize=1.1, background_color=6

al_legend, ['fiducial model', 't!Dself-enrich!N=500 Myr'], charsize=1.1, background_color=6, /bottom
...
tick = replicate(' ',3)
plot, redshift, gpi, /ylog, xrange=[1,50], yrange=[1.0e-6, 3.0], xstyle=1, xtitle='!6redshift', $
      ytitle='!7C!6!DHI!N/10!E-12!Ns!E-1!N', ytickformat='exp2',$
      /xlog, position=[x2,0.1,x2+plotwidth,0.7], xtickname=tick, ystyle=1
axlabel, [1.0, 10.0, 50.0], /xaxis, charsize=1.5, format='(I)'
...
vline, 8.5, linestyle=2
xyouts, 7.5, 1.0e-4, 'z!Dreion!N', orientation=90.0, charsize=1.5, alignment=0.5

legend, ['(b2)'], /right, charsize=1.1, box=0 

xyouts, 10.0, 1.0e-2, 'Total (Pop. III + II)', size=1.0
xyouts, 7.0, 8.0e-6, 'Pop. III (low mass)', alignment=1.0, size=1.0
...
vline, 8.5, linestyle=2
xyouts, 7.5, 1.0e-2, 'z!Dreion!N', orientation=90.0, charsize=1.5, alignment=0.5
...
vline, 8.5, linestyle=2
xyouts, 7.5, 1.0e-3, 'z!Dreion!N', orientation=90.0, charsize=1.5, alignment=0.5
